...
const AddmemberShip = ({handleClose}) => {
    ...
    const handleOnChanege =(event,name)=>{
    ...
    return (
        <div className='text-black'>
            ...
            <div className='flex gap-10 mb-10'>
                <input value={inputField.months} onChange={(event)=>handleOnChanege(event,"months")} className='border-2 rounded-lg text-lg w-1/3 h-1/2 p-2' type="number" placeholder="Add No. of Months" />
                <input value={inputField.price} onChange={(event)=>handleOnChanege(event,"price")} className='border-2 rounded-lg text-lg w-1/3 h-1/2 p-2' type="number" placeholder="Price" />
