    ...
    <div className="w-full">
      ...
      {emailSubmit && (
        <div className="w-full mb-5">
          ...
          <input
            type="text" value={inputField.otp} onChange={(event)=>{handleOnChange(event,"otp")}}
            className="w-1/2 p-2 rounded-lg border-2 border-slate-400"
      ...
      {otpValidate && (
        <div className="w-full mb-5">
          ...
          <input
            type="password" value={inputField.newPassword} onChange={(event)=>{handleOnChange(event,"newPassword")}}
            className="w-1/2 p-2 rounded-lg border-2 border-slate-400"
